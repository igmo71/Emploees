...
namespace Emploees.Migrations
{
    ...
    [Migration("20260121133313_CreateEmploees")]
    partial class CreateEmploees
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Emploees.Domain.City", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
            ...
            modelBuilder.Entity("Emploees.Domain.CostItem", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
            ...
            modelBuilder.Entity("Emploees.Domain.Emploee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36)
                    ...
                    b.Property<string>("EmploeeBuhId")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");

                    b.Property<string>("EmploeeZupId")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
                    ...
                    b.HasIndex("EmploeeBuhId");

                    b.HasIndex("EmploeeZupId");
            ...
            modelBuilder.Entity("Emploees.Domain.JobTitle", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
            ...
            modelBuilder.Entity("Emploees.Domain.Location", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
            ...
            modelBuilder.Entity("Emploees.Domain.Emploee", b =>
                {
                    b.HasOne("Emploees.Domain.City", "City")
                        .WithMany()
                        .HasForeignKey("CityId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Emploees.Domain.CostItem", "CostItem")
                        .WithMany()
                        .HasForeignKey("CostItemId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Emploees.Domain.Catalog_СхемаПредприятия", "Department")
                        .WithMany()
                        .HasForeignKey("DepartmentId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Emploees.Domain.Catalog_Сотрудники_Buh", "EmploeeBuh")
                        .WithMany()
                        .HasForeignKey("EmploeeBuhId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Emploees.Domain.Catalog_Сотрудники_Zup", "EmploeeZup")
                        .WithMany()
                        .HasForeignKey("EmploeeZupId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Emploees.Domain.JobTitle", "JobTitle")
                        .WithMany()
                        .HasForeignKey("JobTitleId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Emploees.Domain.Location", "Location")
                        .WithMany()
                        .HasForeignKey("LocationId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Emploees.Domain.Emploee", "LocationManager")
                        .WithMany()
                        .HasForeignKey("LocationManagerId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Emploees.Domain.Emploee", "OperationManager")
                        .WithMany()
                        .HasForeignKey("OperationManagerId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Emploees.Domain.AdUser", "UserAd")
                        .WithMany()
                        .HasForeignKey("UserAdId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Emploees.Domain.Catalog_Пользователи", "UserUt")
                        .WithMany()
                    ...
                    b.Navigation("EmploeeBuh");

                    b.Navigation("EmploeeZup");
